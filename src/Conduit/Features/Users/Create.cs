...
public class Create
{
    ...
    public class Handler : IRequestHandler<Command, UserEnvelope>
    {
        ...
        public Handler(ConduitContext context, IPasswordHasher passwordHasher, IJwtTokenGenerator jwtTokenGenerator,
            IMapper mapper)
        {
            _context = context;
        ...
        public async Task<UserEnvelope> Handle(Command message, CancellationToken cancellationToken)
        {
            ...
            var person = new Person
            {
                ...
                Hash = await _passwordHasher.Hash(message.User.Password ?? throw new InvalidOperationException(),
                    salt),
                Salt = salt
            };
